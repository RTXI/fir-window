...
void FIRwindow::customizeGUI(void) {
   ...
   saveDateButton->addToolTip("Save filter parameters and coefficients to a file");
   ...
   windowShape = new QComboBox("Window Shape");
   ...
   windowShape->addToolTip("Choose a window to apply. For no window, choose Rectangular.");
   ...
   filterType = new QComboBox("Filter Type");
